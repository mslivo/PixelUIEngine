...
public class ExampleBaseMedia {
    ...
    public static final CMediaAnimation EXAMPLE_ANIMATION_3 = MediaManager.create_CMediaAnimation(DIR_EXAMPLE_GRAPHICS + "example_animation_2.png",  8*8,  8*8, 0.01f);
    ...
    public static final CMedia[] ALL = new CMedia[]{
            EXAMPLE_ANIMATION,EXAMPLE_ANIMATION_3,
