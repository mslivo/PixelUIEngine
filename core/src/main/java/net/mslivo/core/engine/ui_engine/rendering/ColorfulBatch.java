...
public class ColorfulBatch implements Batch {
    ...
    protected float color = pack(0.5137255f, 0.49803922f, 0.49803922f, 1f);
    private final Color tempColor = new Color(0.5137255f, 0.49803922f, 0.49803922f, 1f); // LAB from Palette.GRAY

    private static float pack(float l, float a, float b, float alpha) {
     ...
     */
    public static final float TWEAK_RESET = pack(0.5f, 0.5f, 0.5f, 0.5f);
...
//                        "}\n" +
    ...
    public static float RGBAToOkLab(float r, float g, float b, final float a) {
        r = forwardGamma(r);
        g = forwardGamma(g);
        b = forwardGamma(b);
