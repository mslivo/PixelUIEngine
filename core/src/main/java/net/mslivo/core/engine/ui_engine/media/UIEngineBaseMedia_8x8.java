...
public class UIEngineBaseMedia_8x8 {
    ...
    // Graphics
    public static final CMediaArray UI_WINDOW = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "window.png", TL, TL);
    public static final CMediaArray UI_BUTTON = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "button.png", TL, TL);
    public static final CMediaArray UI_BUTTON_PRESSED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "button_pressed.png", TL, TL);
    public static final CMediaArray UI_SCROLLBAR_VERTICAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "scrollbar_vertical.png", TL, TL);
    public static final CMediaArray UI_SCROLLBAR_HORIZONTAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "scrollbar_horizontal.png", TL, TL);
    public static final CMediaArray UI_SCROLLBAR_BUTTON_VERTICAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "scrollbar_button_vertical.png", TL, TL);
    public static final CMediaArray UI_SCROLLBAR_BUTTON_HORIZONAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "scrollbar_button_horizontal.png", TL, TL);
    ...
    public static final CMediaArray UI_LIST_DRAG = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "list_drag.png", TL, TL * 2);
    public static final CMediaArray UI_COMBOBOX = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "combobox.png", TL, TL);
    public static final CMediaArray UI_TAB_BORDERS = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tab_border.png", TL, TL);
    public static final CMediaArray UI_BORDERS = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "border.png", TL, TL);
    public static final CMediaArray UI_TAB = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tab.png", TL, TL);
    public static final CMediaArray UI_TAB_SELECTED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tab_selected.png", TL, TL);
    ...
    public static final CMediaArray UI_COMBOBOX_OPEN = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "combobox_open.png", TL, TL);
    public static final CMediaArray UI_COMBOBOX_LIST = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "combobox_list.png", TL, TL);
    public static final CMediaArray UI_COMBOBOX_LIST_SELECTED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "combobox_list_selected.png", TL, TL);
    public static final CMediaImage UI_KNOB_BACKGROUND = MediaManager.create_CMediaImage(DIR_UI_GRAPHICS + "knob_background.png");
    public static final CMediaArray UI_KNOB = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "knob.png", TL * 2, TL * 2);
    public static final CMediaArray UI_KNOB_ENDLESS = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "knob_endless.png", TL * 2, TL * 2);
    public static final CMediaArray UI_SEPARATOR_HORIZONTAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "separator_horizontal.png", TL, TL);
    public static final CMediaArray UI_SEPARATOR_VERTICAL = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "separator_vertical.png", TL, TL);
    public static final CMediaArray UI_TOOLTIP = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tooltip.png", TL, TL);
    public static final CMediaArray UI_TOOLTIP_BORDER = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tooltip_border.png", TL, TL);
    public static final CMediaArray UI_TOOLTIP_SEGMENT_BORDER = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "tooltip_segment_border.png", TL, TL);
    public static final CMediaImage UI_TOOLTIP_LINE = MediaManager.create_CMediaImage(DIR_UI_GRAPHICS + "tooltip_line.png");
    public static final CMediaArray UI_CONTEXT_MENU = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "context_menu.png", TL, TL);
    public static final CMediaArray UI_CONTEXT_MENU_SELECTED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "context_menu_selected.png", TL, TL);
    public static final CMediaArray UI_TEXTFIELD = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "textfield.png", TL, TL);
    public static final CMediaArray UI_TEXTFIELD_VALIDATION_OVERLAY = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "textfield_validation_overlay.png", TL, TL);
    public static final CMediaArray UI_TEXTFIELD_FOCUSED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "textfield_focused.png", TL, TL);
    public static final CMediaAnimation UI_TEXTFIELD_CARET = MediaManager.create_CMediaAnimation(DIR_UI_GRAPHICS + "textfield_caret.png", 1, TL, 0.4f);
    public static final CMediaArray UI_GRID = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid.png", TL, TL);
    public static final CMediaArray UI_GRID_DRAGGED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid_dragged.png", TL, TL);
    public static final CMediaArray UI_GRID_SELECTED = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid_selected.png", TL, TL);
    public static final CMediaArray UI_GRID_X2 = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid_x2.png", TL * 2, TL * 2);
    public static final CMediaArray UI_GRID_DRAGGED_X2 = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid_dragged_x2.png", TL * 2, TL * 2);
    public static final CMediaArray UI_GRID_SELECTED_X2 = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "grid_selected_x2.png", TL * 2, TL * 2);
    public static final CMediaArray UI_PROGRESSBAR = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "progressbar.png", TL, TL);
    public static final CMediaArray UI_PROGRESSBAR_BAR = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "progressbar_bar.png", TL, TL);
    public static final CMediaImage UI_NOTIFICATION_BAR = MediaManager.create_CMediaImage(DIR_UI_GRAPHICS + "notification_bar.png");
    public static final CMediaArray UI_CHECKBOX_CHECKBOX = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "checkbox.png", TL, TL);
    public static final CMediaArray UI_CHECKBOX_RADIO = MediaManager.create_CMediaArray(DIR_UI_GRAPHICS + "radio.png", TL, TL);
